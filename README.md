...
<p align="center">
  <img src="docs/images/visual_analysis.png" alt="(a) Multimodal Image Alignment" width="48%">
  <img src="docs/images/visual_analysis_2.png" alt="(b) Structured Content Layout" width="48%">
  <br><br>
  <img src="docs/images/visual_analysis_3.png" alt="(c) Table-to-Chart Transformation" width="48%">
  <img src="docs/images/visual_analysis_4.png" alt="(d) LaTeX Formula Rendering" width="48%">
  <br>
  <i>Figure 2: Qualitative slide generation outputs generated by MASG across diverse technical domains: (a) semantic multimodal image alignment, (b) structured pedagogical bullet points, (c) automated data table-to-chart conversion, and (d) mathematical LaTeX formula rendering.</i>
</p>
